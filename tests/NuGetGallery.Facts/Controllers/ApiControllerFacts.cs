...
namespace NuGetGallery
{
        ...
        : ApiController
    {
            ...
            MockBehavior behavior = MockBehavior.Default)
        {
            ...
            MockSecurityPolicyService.Setup(s => s.EvaluatePackagePoliciesAsync(It.IsAny<SecurityPolicyAction>(), It.IsAny<HttpContextBase>(), It.IsAny<Package>(), It.IsAny<PackageRegistration>()))
                .Returns(Task.FromResult(SecurityPolicyResult.SuccessResult));
    ...
    public class ApiControllerFacts
    {
            ...
            : TestContainer
        {
            ...
            public async Task CreatePackage_Returns400IfPackageSecurityPolicyFails()
            {
                ...
                controller.MockSecurityPolicyService.Setup(s => s.EvaluatePackagePoliciesAsync(It.IsAny<SecurityPolicyAction>(), It.IsAny<HttpContextBase>(), It.IsAny<Package>(), It.IsAny<PackageRegistration>()))
